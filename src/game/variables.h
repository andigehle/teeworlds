...
// SQL
MACRO_CONFIG_STR(SvSqlUser, sv_sql_user, 32, "root", CFGFLAG_SERVER, "SQL User")
MACRO_CONFIG_STR(SvSqlPw, sv_sql_pw, 32, "", CFGFLAG_SERVER, "SQL Password")
...
MACRO_CONFIG_STR(SvSqlDatabase, sv_sql_database, 16, "teedb", CFGFLAG_SERVER, "SQL Database name")
MACRO_CONFIG_STR(SvSqlPrefix, sv_sql_prefix, 16, "", CFGFLAG_SERVER, "SQL Database table prefix")
